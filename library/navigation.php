...
if ( ! class_exists( 'magnificient_walker' ) ) :
class magnificient_walker extends Walker_Nav_Menu {
...
if ( ! class_exists( 'magnificient_offcanvas_walker' ) ) :
class magnificient_offcanvas_walker extends Walker_Nav_Menu {
